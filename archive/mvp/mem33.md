...
| **MCP 集成** | postgresfs, gmailfs, teamsfs, telegramfs, shopifyfs, **githubfs**, **slackfs**, **discordfs** | 8 |
...
| 3 | **slackfs** ✅ | Slack MCP | 消息发送/归档/搜索 | P0 | ✅ 已实现 |
| 4 | **discordfs** ✅ | Discord MCP | 消息归档/频道操作 | P0 | ✅ 已实现 |
