...
const mountHandlers = [
  ...
  http.post('/api/v1/mount', async ({ request }) => {
  ...
  http.post('/api/v1/unmount', async ({ request }) => {
...
const fileHandlers = [
  ...
  http.post('/api/v1/files/:path', async ({ params, request }) => {
  ...
  http.get('/api/v1/files/:path', async ({ params, request }) => {
    const filePath = `/${params.path}`;
  ...
  http.delete('/api/v1/files/:path', ({ params }) => {
    const filePath = `/${params.path}`;
  ...
  http.get('/api/v1/directories/list/:path', () => {
